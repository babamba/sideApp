...
import { View, Button, Image , Text, FlatList, ScrollView, RefreshControl, StyleSheet,StatusBar, Dimensions, TouchableOpacity } from "react-native";
               ...
               <View style={styles.container}>
                    ...
                    <View style={styles.listContainer}>
                         <View style={styles.headerTitle}>
                              ...
                              <TouchableOpacity onPressOut={this.props.pickImage}>
                                   <Text >라이브러리 테스트</Text>
                              </TouchableOpacity>
                              <TouchableOpacity onPressOut={this.props.openCamera}>
                                   <Text >사진 테스트</Text>
                              </TouchableOpacity>
                         </View>
